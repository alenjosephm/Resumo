...
import homeLogo from './../../Assets/homelogoo.png'
                    ...
                    selectBtn
                        ...
                        <>
                            <Heading
                                ...
                                lineHeight={'110%'}>
                                Create your resume in just{' '}
                                <Text as={'span'} color={'#3a5174'}>
                                    four {' '}
                                </Text>
                                steps
                            </Heading>
                            ...
                            Create a resume quickly, easily, and for free with our Resume Builder! In just minutes, build a resume to take your career to the next level.
                            </Text>
                            ...
                            <Flex _dark={{ color: 'gray.50' }} textAlign={'start'} flexDirection={'column'} w={'full'}>
                                ...
                                <Box className='Bullet_Points'>
                                    <Button>2</Button>
                                    <Text _dark={{ color: "gray.400" }} color={'gray.900'} fontSize={'xl'}>
                                        Build you resume using our resume builder.
                                    </Text>
                                </Box>
                                <Box className='Bullet_Points'>
                                    <Button>3</Button>
                                ...
                                <Box className='Bullet_Points'>
                                    <Button>4</Button>
                                    <Text _dark={{ color: "gray.400" }} color={'gray.900'} fontSize={'xl'}>
                                        Create your resume with Self Introduction Audio
                                    </Text>
                                </Box>
                            </Flex>
                        </>
