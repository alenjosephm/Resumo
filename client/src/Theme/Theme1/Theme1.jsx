...
const Theme1 = (props) => {
    ...
    const { name, profile, address, phone, email, skill,self } = themeData.personalData;
            ...
            <Box id="section-to-print" ref={componentRef}>
                <Box _dark={{ border: '1px solid white' }} id="theme1">
                    ...
                    <section id="skills" className='my-2'>
                        <Heading _dark={{ color: 'gray.800' }} bg={'#d1d1d1'} as='h3' size='md' px={20} py={2}>
                            TECHNICAL SKILLS
                        </Heading>
                    ...
                    {/* Award & Achievement */}
                    {
                        ...
                        <Heading  className='my-2' _dark={{ color: 'gray.800' }} bg={'#d1d1d1'} as='h3' size='md' px={20} py={2}>SELF INTRODUCTION AUDIO</Heading>
