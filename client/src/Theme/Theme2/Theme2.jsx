...
const Theme2 = (props) => {
    ...
    const { name, address, phone, email, profile, profileImage, summary, skill,self } = themeData.personalData;
            ...
            <Box id="theme2">
                ...
                <section className='bottom-part d-flex mt-3'>
                    ...
                    <section className='partition-2'>
                        ...
                        {
                         <Box id='self'>
                         <Heading fontSize='2xl' className='mt-4'>Self Introduction Link</Heading>
                         <Box className='mt-1'>
                             {
                              <a href={self} fontSize={'md'}>
                              <text>&nbsp;</text> {self}
                                   </a>   
